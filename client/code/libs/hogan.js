...
var NativeHoganTemplate = (function () {
  ...
  constructor.prototype = {
    ...
    ho: function(val, cx, partials, text) {
      var t = val.call(cx, text, function(t) {
        return NativeHogan.compile(t).render(cx);
      });
      var s = NativeHogan.compile(t.toString()).render(cx, partials);
      this.b = s;
      return false;
    },
    ...
    lv: function(val, ctx, partials) {
      var cx = ctx[ctx.length - 1];
      return NativeHogan.compile(val.call(cx).toString()).render(cx, partials);
    }
  };
...
var NativeHogan = (function () {
  ...
  function generate(tree, text, options) {
    ...
    var template = new NativeHoganTemplate(text);
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = NativeHogan;
  module.exports.Template = NativeHoganTemplate;
} else if (typeof exports !== 'undefined') {
  exports.NativeHogan = NativeHogan;
  exports.NativeHoganTemplate = NativeHoganTemplate;
}
